  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-teal text-white">
        {/* Decorative arrow mark — desktop only */}
        <svg
          aria-hidden="true"
          viewBox="0 0 600 600"
          className="pointer-events-none absolute -right-24 -top-24 hidden h-[600px] w-[600px] text-white/[0.06] lg:block"
        >
          <path d="M120 480 480 120" stroke="currentColor" strokeWidth="40" strokeLinecap="round" />
          <path d="M220 120h260v260" fill="none" stroke="currentColor" strokeWidth="40" strokeLinecap="round" strokeLinejoin="round" />
        </svg>

        <Container className="relative flex flex-col items-start gap-8 py-20 sm:py-28">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm text-white/90">
            <span className="h-1.5 w-1.5 rounded-full bg-amber" />
            Web design & brand identity for African SMEs
          </div>
          <h1 className="max-w-2xl font-display text-[2.5rem] font-extrabold leading-[1.1] tracking-tight sm:text-6xl">
            Get a website that brings you customers
          </h1>
          <p className="max-w-lg text-[17px] leading-relaxed text-white/80 sm:text-xl">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <CTAButton href="/work" variant="secondary">See our work</CTAButton>
          </div>
        </Container>
      </section>
      ...
      <section className="py-20 sm:py-28">
        <Container>
          <div className="mb-12">
            ...
            <p className="mt-3 max-w-lg text-[16px] text-charcoal-soft">
              Built for the realities of running a business in Africa — not just adapted from somewhere else.
            </p>
          </div>
      ...
      {/* ── Case studies ── */}
      <section className="bg-teal-tint py-20 sm:py-28">
        <Container>
          <div className="mb-12">
            <h2 className="font-display text-2xl font-bold text-charcoal sm:text-3xl">
              See it in action
            </h2>
            <p className="mt-3 max-w-md text-[16px] text-charcoal-soft">
      ...
      <section className="bg-teal text-white">
        <Container className="flex flex-col items-start gap-6 py-20 sm:items-center sm:py-24 sm:text-center">
          ...
          <p className="max-w-md text-white/75 text-[16px]">
